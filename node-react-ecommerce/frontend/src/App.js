...
function App() {
  ...
  const cartCount = cartState.cartItems
    ? cartState.cartItems.reduce((a, c) => a + c.qty, 0)
    : 0;
        ...
        <footer className="footer">
          <div className="footer-grid">
            <div className="footer-brand">
              ...
              <p>A modern e-commerce experience built with React &amp; Node.js. Find the best products at unbeatable prices.</p>
            </div>
