        ...
        <section className="hero" ref={heroRef}>
          ...
          <div className={`hero-content ${heroInView ? 'anim-in' : ''}`}>
            ...
            <div className="hero-stats">
              ...
              <div className="hero-stat-divider" />
              <div className="hero-stat">
                <strong><Counter end={35} suffix="+" /></strong>
                <span>Products</span>
              </div>
            </div>
          </div>
      ...
      {!category && (
        <section className="features-strip">
          {[
            ...
            { icon: '💬', title: '24/7 Support', desc: 'Click for live AI help', isChat: true },
          ].map((f) => (
            <div
              className="feature-item"
              key={f.title}
              onClick={f.isChat ? () => window.dispatchEvent(new Event('openSupportChat')) : undefined}
              style={{ cursor: f.isChat ? 'pointer' : 'default' }}
            >
